...
{ 
    ...
    destinations.SetParameters("April", 16, 28, "Male", "Eco-Lodge", 46853.25);

    //this is where front-end goes 
    userInput.month = "April";
    userInput.duration = 16;
    userInput.age = 28;
    userInput.gender = "Male";
    userInput.accommodation = "Eco-Lodge";
    userInput.budget = 46853.25;
    ...
    while (getline(inputFile, line)) 
    {
        ...
        destinations.Insert(place); //{city, month, duration, age, gender, accomodation, budget});
    ...
    std::cout << "Vacation city: " << toRecommend.city << endl;
    std::cout << "Info: " << toRecommend.month << toRecommend.age << toRecommend.gender << toRecommend.budget << endl; 
    
    std::cout << "Destination: " << destinations.Peek().city << endl;
    std::cout << "Cost: " << destinations.Peek().budget << endl;
